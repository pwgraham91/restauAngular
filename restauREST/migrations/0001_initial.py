    ...
    operations = [
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(
                    ...
                    help_text='The groups this user belongs to. '
                              'A user will get all permissions granted to each of his/her group.',
                    verbose_name='groups')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant', models.ForeignKey(related_name='restaurants', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='party',
            name='table',
            field=models.ForeignKey(related_name='tables', to='restauREST.Table'),
